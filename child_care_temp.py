...
if __name__ == '__main__':
    ...
    temp = open('Child_Care_Centers_clean.csv', 'r')
    ...
    for date_idx, date in enumerate(li[1:]):
        print('---------', date, date_idx, '---------')
        f = open('../temp/MOD_LSTD_M_' + date + '_rgb_3600x1800.SS.CSV', 'r')
        reader = csv.reader(f)
        data_li = []
    ...
    f_final = open('child_care_temp_final.csv', 'w')
